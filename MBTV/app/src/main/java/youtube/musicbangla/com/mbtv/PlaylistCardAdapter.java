package youtube.musicbangla.com.mbtv;
...
import youtube.musicbangla.com.mbtv.model.Playlist;
...
public class PlaylistCardAdapter extends RecyclerView.Adapter<PlaylistCardAdapter.ViewHolder> {
    ...
    public void onBindViewHolder(final ViewHolder holder, final int position) {
        ...
        final Video video = (Video) mPlaylist.get(position);
        ...
        holder.mThumbnailImage.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                Intent intent = new Intent(holder.mContext,YoutubePlayActivity.class);
